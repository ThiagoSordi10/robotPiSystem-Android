...
import br.com.thiago.robotPi.helper.Permissao;
...
public class ConfiguracoesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //identificadorUsuario = UsuarioHelper.getIdentificadorUsuario();
        ...
        FirebaseUser usuario = UsuarioHelper.getUsuarioAtual();
        ...
        imageAtualizarNome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                boolean retorno = UsuarioHelper.atualizarNomeUsuario( nome );
                if ( retorno ){
